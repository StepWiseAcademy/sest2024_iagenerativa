...
- Atualize o caminho para a pasta ``documentos``. O conteúdo do arquivo de ser algo como: ``C:\...\rag\documentos``
- Atualize o caminho para a pasta ``chroma``. O conteúdo do arquivo de ser algo como: ``C:\...\rag\chroma``
